...
Три исхода вместо двух (Р1), и здесь это не формальность: «лид не уехал в HubSpot»
...
и выдавать это за успех нельзя (Е2: вердикт выводится из того, что исполнилось).
"""
