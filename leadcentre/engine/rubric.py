...
# ИЗМЕРЕНО 2026-09-09: при пороге 30 негативный контроль urg-02 («12 рабочих мест
# с 1 октября, бюджет есть, готовы подписать договор на год», получено 17 августа —
# 45 дней) уезжал в MEDIUM, хотя разметка человека считает такой лид горячим. Для
# аренды офиса и регистрации решение принимают за месяц-два, поэтому горизонт шире
# календарного месяца. На пороге 60: контроли 6 из 6, каппа 0.787, доля HIGH 19%.
