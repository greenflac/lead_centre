...
A note specific to this project: reviews here are blunt about **code** — a claim without a
command behind it gets asked for the command, and an unverified number gets marked
unverified. That bluntness is aimed at the work, never at the person. "This is not
measured" is fine; "you are careless" is not.
...
maintainer, [@greenflac](https://github.com/greenflac). If the report can be public, open
an issue; if it cannot, contact the maintainer directly on GitHub. This is a small,
best-effort project: expect a human reply rather than a process, and no publication of
reporter details.
...
the people involved for a specified period of time. Violating these terms may lead to a
...
The Contributor Covenant is distributed under [CC BY 4.0][cc-by]; this adaptation keeps the
attribution above, as that licence requires.
