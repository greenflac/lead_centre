...
Правило файла: ожидаемые значения в тестах — литералы. Отсюда экспортируются
...
def make_message(text: str = "Нужен офис и виза для новой компании", **overrides):
    """Обращение из клиентского канала. Текст непустой: пустой — отдельный негативный контроль."""
